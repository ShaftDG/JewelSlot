function  GenerateWinCombination(numCilinder, numPlayingSymbPerCilinder, totalSymb) {
    ...
    this.r = [
        [ 0, 0, 3, 2, 0, 2, 2, 7, 5, 5, 6, 6, 6, 5, 7, 5, 1, 1, 4, 1, 4, 7, 4, 3, 0 ],
        [ 0, 0, 0, 3, 4, 7, 4, 2, 4, 2, 2, 5, 0, 5, 5, 5, 1, 1, 0, 1, 6, 6, 6, 6, 7 ],
        [ 3, 0, 0, 2, 2, 6, 2, 5, 7, 5, 0, 5, 6, 6, 6, 7, 4, 4, 4, 0, 4, 1, 1, 3, 1 ],
        [ 0, 0, 0, 1, 1, 0, 4, 4, 4, 4, 0, 4, 3, 3, 7, 2, 2, 5, 5, 5, 6, 5, 6, 6, 6 ],
        [ 0, 0, 0, 5, 2, 5, 1, 1, 4, 7, 4, 2, 4, 7, 4, 3, 3, 5, 0, 6, 6, 6, 2, 2, 0 ]
    ];
  /*  this.r = [
